  ...
  return (
    <div>
      ...
      <div style={mapStyle}>
        ...
        <iframe title="map" src="https://yandex.kz/map-widget/v1/?ll=76.905584%2C43.217171&mode=whatshere&utm_campaign=desktop&utm_medium=search&utm_source=maps&whatshere%5Bpoint%5D=76.905468%2C43.217340&whatshere%5Bzoom%5D=17&z=18.28" width="100%" height="500" frameborder="0" allowfullscreen="true" style={{position:'relative'}}></iframe>
      </div>
    </div>
  );
}
