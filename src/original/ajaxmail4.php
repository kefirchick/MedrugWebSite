...
if(trim($un)!="" && trim($su)!="" && trim($em)!=""){
		if(filter_var($em, FILTER_VALIDATE_EMAIL)){
			//if(preg_match("/^[0-9]*$/", $phone) && strlen($phone)>6) { 
				...
				if(mail('a.egamberdiev@gmail.com','Заявка на сервисное обслуживание с сайта SonoTrade.uz',$message,$headers )){
					echo '1#<p style="color:green;">Mail has been sent successfully.</p>';
					sleep(1);
					header('Location: https://sonotrade.uz/pages/service.html');
					exit( );
				}else{
