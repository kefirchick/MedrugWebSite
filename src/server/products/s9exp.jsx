const s9exp = () => {
   return (
      <p>
         Портативный ультразвуковой аппарат SonoScape S9Exp. стал настоящим прорывом в области УЗИ технологий. Эта мощная и многофункциональная переносная система вполне сравнима со стационарными аналогами, а зачастую способна дать им фору. Традиционно высокое для SonoScape качество изображения вышло на новый уровень!
         <br /><br />
         Компактный и изящный УЗИ аппарат SonoScape S9Exp. создан в стремлении к совершенству, что нашло отражение в многочисленных технологических опциях. Благодаря высокой мобильности и конкурентной цене, он станет незаменимым помощником при проведении исследований как в медицинских центрах, так и при выезде специалиста к пациенту.
         <br /><br />                         
