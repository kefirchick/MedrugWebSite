const s15 = () => {
   return (
      <p>
         Надежный и востребованный среди специалистов, УЗИ сканер S15 от официального производителя SonoScape является стандартной моделью для оснащения медицинских центров по всему миру. Вместо обилия технических функций упор сделан на высокое качество по доступной цене.
         <br /><br />
         Вместе с тем, УЗИ аппарат SonoScape S15 остается весьма привлекательным устройством, снискавшим заслуженно высокие оценки врачей. Каждая из заложенных в нем опций отвечает современным требованиям, а отсутствие излишеств помогает докторам быстрее освоить данную технику.
         <br /><br />                         
